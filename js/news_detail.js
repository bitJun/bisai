$(function(){
  ...
  let str = '';
  list.forEach((item)=>{
    str += '<li class="news_info_section_tuijian_list_item"><a href="/news_detail.html" target="_blank" title="'+item.title+'">';
    str += '<img src="'+item.img+'" alt="'+item.title+'">';
    str += '<div class="news_info_section_tuijian_list_item_main">';
    str += ''+item.title+'';
    str += '</div>';
    str += '</a></li>';
  })
  $('.news_info_section_tuijian_list').html(str);
  let videoList = [
    {
      img: 'https://nimg.ws.126.net/?url=http%3A%2F%2Fcms-bucket.ws.126.net%2F2023%2F0329%2Fea0d0df8p00rs96yn001jc0009c0070c.png&thumbnail=140y88&quality=100&type=jpg',
      title: '名宿都怕了！切尔西亿元先生完美首秀 贵有贵的道理',
  ...
  $('.news_info_section_detail_video ul').html(videoStr);
  let newsList = [
    {
      img: 'https://nimg.ws.126.net/?url=http%3A%2F%2Fcms-bucket.ws.126.net%2F2023%2F0329%2Fea0d0df8p00rs96yn001jc0009c0070c.png&thumbnail=140y88&quality=100&type=jpg',
      title: '名宿都怕了！切尔西亿元先生完美首秀 贵有贵的道理',
  ...
  $('.news_info_section_detail_news ul').html(newsStr);
})